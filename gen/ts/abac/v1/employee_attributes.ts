...
//   protoc               unknown
// source: abac/v1/employee_attributes.proto

/* eslint-disable */
import { BinaryReader, BinaryWriter } from "@bufbuild/protobuf/wire";

export interface EmployeeAttribute {
  $type: "abac.v1.EmployeeAttribute";
  id: string;
  employeeId: string;
  companyId: string;
  attributeId: string;
...
function createBaseEmployeeAttribute(): EmployeeAttribute {
  return { $type: "abac.v1.EmployeeAttribute", id: "", employeeId: "", companyId: "", attributeId: "", value: "" };
}

export const EmployeeAttribute: MessageFns<EmployeeAttribute, "abac.v1.EmployeeAttribute"> = {
  $type: "abac.v1.EmployeeAttribute" as const,
...
> = {
  ...
  fromJSON(object: any): CreateEmployeeAttributeCompinsateRequest {
    return {
      ...
      employeeAttributeId: isSet(object.employeeAttributeId) ? globalThis.String(object.employeeAttributeId) : "",
    };
  },
