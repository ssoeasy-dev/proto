...
function createBaseCompany(): Company {
  return { $type: "companies.v1.Company", id: "", email: "", name: "", description: "", ownerId: "", isActive: false };
}

export const Company: MessageFns<Company, "companies.v1.Company"> = {
  $type: "companies.v1.Company" as const,
