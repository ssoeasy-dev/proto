...
function createBaseEmployee(): Employee {
  return { $type: "companies.v1.Employee", id: "", email: "", firstName: "", lastName: "", isActive: false };
}

export const Employee: MessageFns<Employee, "companies.v1.Employee"> = {
  $type: "companies.v1.Employee" as const,
