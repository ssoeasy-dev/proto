...
export interface Subscription {
  $type: "companies.v1.Subscription";
  id: string;
  isActive: boolean;
  serviceId: string;
  companyId: string;
...
function createBaseSubscription(): Subscription {
  return { $type: "companies.v1.Subscription", id: "", isActive: false, serviceId: "", companyId: "" };
}

export const Subscription: MessageFns<Subscription, "companies.v1.Subscription"> = {
  $type: "companies.v1.Subscription" as const,
